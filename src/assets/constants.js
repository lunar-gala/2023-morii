export const STORY = [
  ...
  { text: '"How do I know this is real?"', classes: [], screen: 3 },
  { text: '"You built it."', classes: [], screen: 3 },
  { text: '"How will I know when to let go?"', classes: [], screen: 3 },
  { text: '"I don\'t think you will."', classes: [], screen: 3 },
  {
  ...
  { text: '"What if we never had to leave?"', classes: [], screen: 6 },
];
