...
export default class Figure {
  constructor(scene, cb) {
    ...
    this.$overlayImg = document.querySelector(".tile__image-overlay");
    this.scene = scene;
    this.callback = cb;
    ...
    console.log(this.$image.dataset.hover, this.$image.src);
    this.hover = this.loader.load(this.$overlayImg.src);
